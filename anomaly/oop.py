...
from onelens.onelens_pycaret.containers.metrics.anomaly import get_all_metric_containers
from onelens.onelens_pycaret.containers.models.anomaly import get_all_model_containers
...
class AnomalyExperiment(_UnsupervisedExperiment):
    ...
    def predict_model(
        ...
        >>> from onelens.onelens_pycaret.anomaly import *

...
from onelens.onelens_pycaret.containers.metrics.regression import get_all_metric_containers
from onelens.onelens_pycaret.containers.models.regression import (
    ALL_ALLOWED_ENGINES,
...
class RegressionExperiment(_NonTSSupervisedExperiment, Preprocessor):
    ...
    def compare_models(
        ...
        >>> from onelens.onelens_pycaret.regression import *
    ...
    def load_model(
        ...
        Example
        -------
        >>> from onelens.onelens_pycaret.regression import load_model

...
import onelens.onelens_pycaret.internal.patches.sklearn
import onelens.onelens_pycaret.internal.patches.yellowbrick
import onelens.onelens_pycaret.internal.persistence
import onelens.onelens_pycaret.internal.preprocess
from onelens.onelens_pycaret.containers.metrics.classification import (
    get_all_metric_containers as get_all_class_metric_containers,
)
from onelens.onelens_pycaret.containers.metrics.regression import (
    get_all_metric_containers as get_all_reg_metric_containers,
)
from onelens.onelens_pycaret.internal.display import CommonDisplay, DummyDisplay
from onelens.onelens_pycaret.internal.distributions import (
...
from onelens.onelens_pycaret.internal.logging import get_logger, redirect_output
from onelens.onelens_pycaret.internal.meta_estimators import (
    CustomProbabilityThresholdClassifier,
    get_estimator_from_meta_estimator,
)
from onelens.onelens_pycaret.internal.metrics import EncodedDecodedLabelsReplaceScoreFunc, get_pos_label
from onelens.onelens_pycaret.internal.parallel.parallel_backend import ParallelBackend
from onelens.onelens_pycaret.internal.patches.sklearn import fit_and_score as fs
from onelens.onelens_pycaret.internal.pipeline import (
    Pipeline,
    estimator_pipeline,
    get_pipeline_estimator_label,
    get_pipeline_fit_kwargs,
)
from onelens.onelens_pycaret.internal.pycaret_experiment.tabular_experiment import _TabularExperiment
from onelens.onelens_pycaret.internal.tunable import TunableMixin
from onelens.onelens_pycaret.internal.validation import is_fitted, is_sklearn_cv_generator
from onelens.onelens_pycaret.utils._dependencies import _check_soft_dependencies
from onelens.onelens_pycaret.utils.constants import DATAFRAME_LIKE, LABEL_COLUMN, SCORE_COLUMN
from onelens.onelens_pycaret.utils.generic import (
    MLUsecase,
    can_early_stop,
    color_df,
    get_label_encoder,
...
class _SupervisedExperiment(_TabularExperiment):
    ...
    def _calculate_metrics(
        ...
        **additional_kwargs,
        ...
        """
        from onelens.onelens_pycaret.utils.generic import calculate_metrics
    ...
    def _get_cv_n_folds(self, fold, X, y=None, groups=None):
        import onelens.onelens_pycaret.utils.generic

        return onelens. onelens_pycaret.utils.generic.get_cv_n_folds(
    ...
    def compare_models(
        ...
        include: Optional[
            List[Union[str, Any]]
        ] = None,  # changed whitelist to include in onelens. onelens_pycaret==2.1
        exclude: Optional[
            List[str]
        ] = None,  # changed blacklist to exclude in onelens. onelens_pycaret==2.1
        fold: Optional[Union[int, Any]] = None,
        round: int = 4,
        cross_validation: bool = True,
        sort: str = "Accuracy",
        n_select: int = 1,
        budget_time: Optional[float] = None,  # added in onelens. onelens_pycaret==2.1.0
        turbo: bool = True,
        errors: str = "ignore",
        fit_kwargs: Optional[dict] = None,
        groups: Optional[Union[str, Any]] = None,
    ...
    def _create_model(
        ...
        X_train_data: Optional[pd.DataFrame] = None,  # added in onelens. onelens_pycaret==2.2.0
        y_train_data: Optional[pd.DataFrame] = None,  # added in onelens. onelens_pycaret==2.2.0
        metrics=None,
        display: Optional[CommonDisplay] = None,  # added in onelens. onelens_pycaret==2.2.0
        model_only: bool = True,
        return_train_score: bool = False,
    ...
    def tune_model(
        ...
        custom_scorer=None,  # added in onelens. onelens_pycaret==2.1 - depreciated
        ...
        **kwargs:
        ...
        from onelens.onelens_pycaret.internal.tunable import VotingClassifier, VotingRegressor
        ...
        with estimator_pipeline(self.pipeline, model) as pipeline_with_model:
            ...
            if search_library == "scikit-learn":
                ...
                with patch(
                    ...
                    onelens. onelens_pycaret.internal.patches.sklearn._mp_sample_without_replacement,
                ):
                    with patch(
                        "sklearn.model_selection._search.ParameterGrid.__getitem__",
                        onelens. onelens_pycaret.internal.patches.sklearn._mp_ParameterGrid_getitem,
                    ):
    ...
    def blend_models(
        ...
        optimize: str = "Accuracy",
        method: str = "auto",
        weights: Optional[List[float]] = None,  # added in onelens. onelens_pycaret==2.2.0
        fit_kwargs: Optional[dict] = None,
        groups: Optional[Union[str, Any]] = None,
        probability_threshold: Optional[float] = None,
        verbose: bool = True,
    ...
    def interpret_model(
        ...
        **kwargs,  # added in onelens. onelens_pycaret==2.1
    ):
        """
    ...
    def add_metric(
        ...
        **kwargs:
        ...
        if self._ml_usecase == MLUsecase.CLASSIFICATION:
            new_metric = (
                onelens. onelens_pycaret.containers.metrics.classification.ClassificationMetricContainer(
                    id=id,
                    name=name,
            ...
            new_metric = (
                onelens. onelens_pycaret.containers.metrics.time_series.TimeSeriesMetricContainer(
                    id=id,
                    name=name,
            ...
            new_metric = (
                onelens. onelens_pycaret.containers.metrics.regression.RegressionMetricContainer(
                    id=id,
                    name=name,
                    score_func=score_func,
                    args=kwargs,
    ...
    def finalize_model(
        ...
        experiment_custom_tags: Optional[Dict[str, Any]] = None,
    ) -> Any:  # added in onelens. onelens_pycaret==2.2.0
        """
    ...
    def predict_model(
        ...
        probability_threshold: Optional[float] = None,
        encoded_labels: bool = False,  # added in onelens. onelens_pycaret==2.1.0
        raw_score: bool = False,
        round: int = 4,  # added in onelens. onelens_pycaret==2.2.0
        verbose: bool = True,
    ...
    def check_fairness(
        ...
        >>> from onelens.onelens_pycaret.classification import *

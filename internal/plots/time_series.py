...
from onelens.onelens_pycaret.utils.generic import _resolve_dict_keys
from onelens.onelens_pycaret.utils.time_series import get_diffs
...
msg1 = (
    ...
    "\nhttps://github.com/onelens_pycaret/onelens_pycaret/issues"
)
...
def plot_series(
    ...
    PlotReturnType
        ...
        be and customized by them if not supported by onelens. onelens_pycaret by default.

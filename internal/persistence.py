...
from onelens.onelens_pycaret.utils.generic import MLUsecase, get_logger
...
def deploy_model(
    ...
    if platform not in allowed_platforms:
        logger.error(
            f"(Value Error): Platform {platform} is not supported by onelens. onelens_pycaret or illegal option"
        )
        raise ValueError(
            f"Platform {platform} is not supported by onelens. onelens_pycaret or illegal option"
        )
...
def load_model(
    ...
    # cloud providers
        ...
        print(f"Platform {platform} is not supported by onelens. onelens_pycaret or illegal option")
    gc.collect()
...
def _create_bucket_gcp(project_name: str, bucket_name: str):
    ...
    Example
    -------
    >>> _create_bucket_gcp(project_name='GCP-Essentials', bucket_name='test-onelens_pycaret-gcp')
...
def _upload_blob_gcp(
    ...
    Example
    -------
    >>> _upload_blob_gcp(project_name='GCP-Essentials', bucket_name='test-onelens_pycaret-gcp', \
...
def _download_blob_gcp(
    ...
    Example
    -------
    >>> _download_blob_gcp(project_name='GCP-Essentials', bucket_name='test-onelens_pycaret-gcp', \
...
def _create_container_azure(container_name: str):
    ...
    Example
    -------
    >>>  container_client = _create_container_azure(container_name='test-onelens_pycaret-azure')
...
def _upload_blob_azure(
    ...
    Example
    -------
    >>>  _upload_blob_azure(container_name='test-onelens_pycaret-azure', source_file_name='model-101.pkl', \
...
def _download_blob_azure(
    ...
    Example
    -------
    >>>  _download_blob_azure(container_name='test-onelens_pycaret-azure', source_blob_name='model-101.pkl', \

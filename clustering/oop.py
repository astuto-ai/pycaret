...
from onelens.onelens_pycaret.containers.models.clustering import get_all_model_containers
from onelens.onelens_pycaret.internal.logging import get_logger
from onelens.onelens_pycaret.internal.pycaret_experiment.unsupervised_experiment import (
    _UnsupervisedExperiment,
)
from onelens.onelens_pycaret.utils.generic import MLUsecase
...
class ClusteringExperiment(_UnsupervisedExperiment):
    ...
    def add_metric(
        ...
        **kwargs:
        ...
        new_metric = onelens.onelens_pycaret.containers.metrics.clustering.ClusterMetricContainer(
            id=id,
            name=name,

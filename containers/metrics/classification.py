...
import onelens.onelens_pycaret.internal.metrics
from onelens.onelens_pycaret.containers.metrics.base_metric import MetricContainer
...
class ClassificationMetricContainer(MetricContainer):
    ...
    def __init__(
        ...
        scorer = (
            scorer
            if scorer
            else onelens.onelens_pycaret.internal.metrics.make_scorer_with_error_score(
                score_func,
...
class ROCAUCMetricContainer(ClassificationMetricContainer):
    def __init__(self, globals_dict: dict) -> None:
        ...
        score_func = onelens.onelens_pycaret.internal.metrics.BinaryMulticlassScoreFunc(
        ...
        super().__init__(
            ...
            name="AUC",
            score_func=score_func,
            scorer=onelens_pycaret.internal.metrics.make_scorer_with_error_score(
                score_func,
...
class RecallMetricContainer(ClassificationMetricContainer):
    def __init__(self, globals_dict: dict) -> None:
        ...
        score_func = onelens.onelens_pycaret.internal.metrics.BinaryMulticlassScoreFunc(
            onelens.onelens_pycaret.internal.metrics.EncodedDecodedLabelsScoreFunc(
                metrics.recall_score,
                onelens.onelens_pycaret.internal.metrics.get_pos_label(globals_dict),
            ),
...
class F1MetricContainer(ClassificationMetricContainer):
    def __init__(self, globals_dict: dict) -> None:
        ...
        score_func = onelens.onelens_pycaret.internal.metrics.BinaryMulticlassScoreFunc(
            onelens.onelens_pycaret.internal.metrics.EncodedDecodedLabelsScoreFunc(
                metrics.f1_score, onelens.onelens_pycaret.internal.metrics.get_pos_label(globals_dict)
            ),
            kwargs_if_binary={"average": "binary"},
        )
        super().__init__(

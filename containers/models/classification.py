...
import onelens.onelens_pycaret.internal.cuml_wrappers
from onelens.onelens_pycaret.containers.models.base_model import (
    ModelContainer,
    leftover_parameters_to_categorical_distributions,
)
from onelens.onelens_pycaret.internal.cuml_wrappers import get_svc_classifier
...
class MLPClassifierContainer(ClassifierContainer):
    def __init__(self, experiment):
        ...
        from onelens.onelens_pycaret.internal.tunable import TunableMLPClassifier
...
class RidgeClassifierContainer(ClassifierContainer):
    def __init__(self, experiment):
        ...
        if gpu_imported:
            RidgeClassifier = onelens. onelens_pycaret.internal.cuml_wrappers.get_ridge_classifier()
        else:
            args = {"random_state": experiment.seed}
    ...
    def __init__(self, experiment):
        ...
        if gpu_imported:
            RandomForestClassifier = (
                onelens. onelens_pycaret.internal.cuml_wrappers.get_random_forest_classifier()
            )
...
class VotingClassifierContainer(ClassifierContainer):
    def __init__(self, experiment):
        ...
        from onelens.onelens_pycaret.internal.tunable import TunableVotingClassifier

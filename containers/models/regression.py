    ...
    def __init__(self, experiment):
        ...
        if gpu_imported:
            RandomForestRegressor = (
                onelens. onelens_pycaret.internal.cuml_wrappers.get_random_forest_regressor()
            )
...
class MLPRegressorContainer(RegressorContainer):
    def __init__(self, experiment):
        ...
        from onelens.onelens_pycaret.internal.tunable import TunableMLPRegressor
...
class VotingRegressorContainer(RegressorContainer):
    def __init__(self, experiment):
        ...
        from onelens.onelens_pycaret.internal.tunable import TunableVotingRegressor

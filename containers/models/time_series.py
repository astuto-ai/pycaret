...
import onelens.onelens_pycaret.containers.base_container
from onelens.onelens_pycaret.containers.models.base_model import (
    ModelContainer,
...
from onelens.onelens_pycaret.utils.datetime import (
    coerce_datetime_to_period_index,
    coerce_period_to_datetime_index,
)
from onelens.onelens_pycaret.utils.generic import get_logger, np_list_arange, param_grid_to_lists
from onelens.onelens_pycaret.utils.time_series import TSModelTypes
from onelens.onelens_pycaret.utils.time_series.forecasting.models import _check_enforcements
...
if _check_soft_dependencies("prophet", extra=None, severity="warning"):
    ...
    class ProphetPeriodPatched(Prophet):
        ...
        def predict(self, fh=None, X=None):
            ...
            # In that case, onelens. onelens_pycaret will always pass PeriodIndex from outside
            # since Datetime index are converted to PeriodIndex in onelens. onelens_pycaret
            ...
            # Convert back to PeriodIndex for onelens. onelens_pycaret
...
def get_all_model_containers(
    ...
    return onelens. onelens_pycaret.containers.base_container.get_all_containers(

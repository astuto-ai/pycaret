...
class BaseContainer:
    ...
    def get_class_name(self):
        return onelens.onelens_pycaret.utils.generic.get_class_name(self.class_def)

    def get_package_name(self):
        return onelens.onelens_pycaret.utils.generic.get_package_name(self.class_def)

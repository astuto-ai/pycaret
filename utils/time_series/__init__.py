...
def clean_time_index(
    ...
    """Cleans and sets the index of the dataframe in a onelens. onelens_pycaret compliant format.

    Allowed index in onelens. onelens_pycaret can be of type Int64Index, DatetimeIndex, or PeriodIndex.
    ...
    if index_col is not None:
        # If column has string values, convert to PeriodIndex since onelens. onelens_pycaret
    ...
    if isinstance(data_.index, pd.DatetimeIndex):
        try:
            ...
            raise AttributeError(
                ...
                "and pass to onelens. onelens_pycaret:\n"
                ">>> data.index = data.index.astype('int64') "
                "\nLater, when you get the results back from "
                "onelens_pycaret, you can convert them back to DatetimeIndex by using:\n"

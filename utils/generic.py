...
from onelens.onelens_pycaret.internal.validation import (
...
def get_model_id(
    e, all_models: Dict[str, "onelens.onelens_pycaret.containers.models.ModelContainer"]
) -> str:
    from onelens.onelens_pycaret.internal.meta_estimators import get_estimator_from_meta_estimator
...
def get_model_name(
    e,
    all_models: Dict[str, "onelens.onelens_pycaret.containers.models.ModelContainer"],
    deep: bool = True,
) -> str:
...
def calculate_unsupervised_metrics(
    metrics: Dict[str, "onelens.onelens_pycaret.containers.metrics.MetricContainer"],
    X,
    labels,
...
def check_metric(
    ...
    from onelens.onelens_pycaret.containers.metrics.time_series import (
...
def enable_colab():
    # TODO: Remove with onelens. onelens_pycaret v3.2.1
    warnings.warn(
        "This function is no longer necessary in onelens. onelens_pycaret>=3.0 "
